...
class com_componentbuilderInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			$admin_view->field_mappings = '{"common": {"core_content_item_id": "id","core_title": "null","core_state": "published","core_alias": "null","core_created_time": "created","core_modified_time": "modified","core_body": "null","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "null","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "null","core_metadesc": "null","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"system_name":"system_name","name_single":"name_single","name_list":"name_list","short_description":"short_description","add_php_allowedit":"add_php_allowedit","add_php_getitems":"add_php_getitems","add_php_after_delete":"add_php_after_delete","type":"type","add_php_save":"add_php_save","description":"description","add_php_batchmove":"add_php_batchmove","icon":"icon","add_sql":"add_sql","icon_add":"icon_add","php_import_setdata":"php_import_setdata","icon_category":"icon_category","add_php_getlistquery":"add_php_getlistquery","add_php_postsavehook":"add_php_postsavehook","add_php_batchcopy":"add_php_batchcopy","add_php_before_delete":"add_php_before_delete","add_php_document":"add_php_document","add_custom_import":"add_custom_import","php_import":"php_import","php_getitem":"php_getitem","add_css_view":"add_css_view","php_getitems":"php_getitems","css_view":"css_view","php_getlistquery":"php_getlistquery","add_css_views":"add_css_views","php_save":"php_save","css_views":"css_views","php_postsavehook":"php_postsavehook","add_javascript_view_file":"add_javascript_view_file","php_allowedit":"php_allowedit","javascript_view_file":"javascript_view_file","php_batchcopy":"php_batchcopy","add_javascript_view_footer":"add_javascript_view_footer","php_batchmove":"php_batchmove","javascript_view_footer":"javascript_view_footer","php_before_delete":"php_before_delete","add_javascript_views_file":"add_javascript_views_file","php_after_delete":"php_after_delete","javascript_views_file":"javascript_views_file","php_document":"php_document","add_javascript_views_footer":"add_javascript_views_footer","source":"source","javascript_views_footer":"javascript_views_footer","sql":"sql","add_php_ajax":"add_php_ajax","php_ajaxmethod":"php_ajaxmethod","html_import_view":"html_import_view","php_import_save":"php_import_save","add_php_getitem":"add_php_getitem","not_required":"not_required"}}';
			$admin_view->router = 'ComponentbuilderHelperRoute::getAdmin_viewRoute';
			$admin_view->content_history_options = '{"formFile": "administrator/components/com_componentbuilder/models/forms/admin_view.xml","hideFields": ["asset_id","checked_out","checked_out_time","version","not_required"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","add_php_allowedit","add_php_getitems","add_php_after_delete","type","add_php_save","add_php_batchmove","add_sql","add_php_getlistquery","add_php_postsavehook","add_php_batchcopy","add_php_before_delete","add_php_document","add_custom_import","add_css_view","add_css_views","add_javascript_view_file","add_javascript_view_footer","add_javascript_views_file","add_javascript_views_footer","source","add_php_ajax","add_php_getitem","not_required"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"}]}';
