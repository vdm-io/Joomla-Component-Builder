...
class com_componentbuilderInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			$admin_view->field_mappings = '{"common": {"core_content_item_id": "id","core_title": "null","core_state": "published","core_alias": "null","core_created_time": "created","core_modified_time": "modified","core_body": "php_getitems_after_all","core_hits": "hits","core_publish_up": "null","core_publish_down": "null","core_access": "access","core_params": "params","core_featured": "null","core_metadata": "null","core_language": "null","core_images": "null","core_urls": "null","core_version": "version","core_ordering": "ordering","core_metakey": "null","core_metadesc": "null","core_catid": "null","core_xreference": "null","asset_id": "asset_id"},"special": {"system_name":"system_name","name_single":"name_single","short_description":"short_description","add_php_before_cancel":"add_php_before_cancel","add_php_allowadd":"add_php_allowadd","add_php_save":"add_php_save","add_php_getform":"add_php_getform","add_php_getitems_after_all":"add_php_getitems_after_all","icon":"icon","add_php_after_delete":"add_php_after_delete","add_fadein":"add_fadein","description":"description","icon_category":"icon_category","icon_add":"icon_add","add_php_batchmove":"add_php_batchmove","add_sql":"add_sql","add_php_after_publish":"add_php_after_publish","html_import_view":"html_import_view","mysql_table_engine":"mysql_table_engine","type":"type","not_required":"not_required","php_import_save":"php_import_save","add_php_getlistquery":"add_php_getlistquery","add_php_before_save":"add_php_before_save","add_php_postsavehook":"add_php_postsavehook","add_php_allowedit":"add_php_allowedit","add_php_batchcopy":"add_php_batchcopy","add_php_before_publish":"add_php_before_publish","add_php_before_delete":"add_php_before_delete","add_php_document":"add_php_document","alias_builder_type":"alias_builder_type","mysql_table_collate":"mysql_table_collate","add_custom_import":"add_custom_import","alias_builder":"alias_builder","php_import_headers":"php_import_headers","name_list":"name_list","php_getitems_after_all":"php_getitems_after_all","add_css_view":"add_css_view","php_getlistquery":"php_getlistquery","css_view":"css_view","php_getform":"php_getform","add_css_views":"add_css_views","php_before_save":"php_before_save","css_views":"css_views","php_save":"php_save","add_javascript_view_file":"add_javascript_view_file","php_postsavehook":"php_postsavehook","javascript_view_file":"javascript_view_file","php_allowadd":"php_allowadd","add_javascript_view_footer":"add_javascript_view_footer","php_allowedit":"php_allowedit","javascript_view_footer":"javascript_view_footer","php_before_cancel":"php_before_cancel","add_javascript_views_file":"add_javascript_views_file","php_batchcopy":"php_batchcopy","javascript_views_file":"javascript_views_file","php_batchmove":"php_batchmove","add_javascript_views_footer":"add_javascript_views_footer","php_before_publish":"php_before_publish","javascript_views_footer":"javascript_views_footer","php_after_publish":"php_after_publish","add_custom_button":"add_custom_button","php_before_delete":"php_before_delete","php_after_delete":"php_after_delete","php_controller":"php_controller","php_document":"php_document","php_model":"php_model","mysql_table_charset":"mysql_table_charset","php_controller_list":"php_controller_list","mysql_table_row_format":"mysql_table_row_format","php_model_list":"php_model_list","source":"source","add_php_ajax":"add_php_ajax","sql":"sql","php_ajaxmethod":"php_ajaxmethod","php_import_display":"php_import_display","add_php_getitem":"add_php_getitem","php_import":"php_import","php_getitem":"php_getitem","php_import_setdata":"php_import_setdata","add_php_getitems":"add_php_getitems","php_import_ext":"php_import_ext","php_getitems":"php_getitems"}}';
			$admin_view->router = 'ComponentbuilderHelperRoute::getAdmin_viewRoute';
			$admin_view->content_history_options = '{"formFile": "administrator/components/com_componentbuilder/models/forms/admin_view.xml","hideFields": ["asset_id","checked_out","checked_out_time","version","not_required"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","add_php_before_cancel","add_php_allowadd","add_php_save","add_php_getform","add_php_getitems_after_all","add_php_after_delete","add_fadein","add_php_batchmove","add_sql","add_php_after_publish","type","add_php_getlistquery","add_php_before_save","add_php_postsavehook","add_php_allowedit","add_php_batchcopy","add_php_before_publish","add_php_before_delete","add_php_document","add_custom_import","add_css_view","add_css_views","add_javascript_view_file","add_javascript_view_footer","add_javascript_views_file","add_javascript_views_footer","add_custom_button","source","add_php_ajax","add_php_getitem","add_php_getitems"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "alias_builder","targetTable": "#__componentbuilder_field","targetColumn": "id","displayColumn": "name"}]}';
		...
		if ($type == 'update')
		{
			...
			echo '<a target="_blank" href="http://www.joomlacomponentbuilder.com" title="Component Builder">
				...
				<h3>Upgrade to Version 2.9.19 Was Successful! Let us know if anything is not working as expected.</h3>';
		}
	}
