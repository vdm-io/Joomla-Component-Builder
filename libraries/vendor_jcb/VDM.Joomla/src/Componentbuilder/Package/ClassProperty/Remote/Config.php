...
namespace VDM\Joomla\Componentbuilder\Package\ClassProperty\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'class_property';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Class Property';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/class-property.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/class_property';
}
