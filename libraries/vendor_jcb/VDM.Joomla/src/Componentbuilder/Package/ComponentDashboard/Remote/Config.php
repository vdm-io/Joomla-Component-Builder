...
namespace VDM\Joomla\Componentbuilder\Package\ComponentDashboard\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_dashboard';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Dashboard';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-dashboard.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-dashboard.json';
