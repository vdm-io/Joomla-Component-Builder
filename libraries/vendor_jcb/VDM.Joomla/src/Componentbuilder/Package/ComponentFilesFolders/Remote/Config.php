...
namespace VDM\Joomla\Componentbuilder\Package\ComponentFilesFolders\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_files_folders';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Files Folders';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-files-folders.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-files-folders.json';
