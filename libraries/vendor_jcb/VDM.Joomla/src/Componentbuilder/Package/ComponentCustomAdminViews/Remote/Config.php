...
namespace VDM\Joomla\Componentbuilder\Package\ComponentCustomAdminViews\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_custom_admin_views';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Custom Admin Views';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-custom-admin-views.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-custom-admin-views.json';
