...
namespace VDM\Joomla\Componentbuilder\Package\ComponentAdminViews\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_admin_views';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Admin Views';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-admin-views.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-admin-views.json';
