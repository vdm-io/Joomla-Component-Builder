...
namespace VDM\Joomla\Componentbuilder\Package\ComponentRouter\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_router';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Router';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-router.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-router.json';
