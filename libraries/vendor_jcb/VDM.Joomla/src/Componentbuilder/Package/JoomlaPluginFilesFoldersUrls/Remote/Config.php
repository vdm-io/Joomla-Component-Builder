...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaPluginFilesFoldersUrls\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_plugin_files_folders_urls';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Plugin Files Folders Urls';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-plugin-files-folders-urls.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'joomla-plugin-files-folders-urls.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/joomla_plugin/children';
	 ...
	 * @since  5.1.1
	 */
	protected string $guid_field = 'joomla_plugin';
	...
	protected array $files = [
		'addfiles|file' => 'custom',
		'addfilesfullpath|filepath' => 'full'
	];
	...
	protected array $folders = [
		'addfolders|folder' => 'custom',
		'addfoldersfullpath|folderpath' => 'full'
	];
}
