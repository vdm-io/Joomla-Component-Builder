...
namespace VDM\Joomla\Componentbuilder\Package\LibraryFilesFoldersUrls\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'library_files_folders_urls';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Library Files Folders Urls';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/library-files-folders-urls.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'library-files-folders-urls.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/library/children';
	 ...
	 * @since  5.1.1
	 */
	protected string $guid_field = 'library';
