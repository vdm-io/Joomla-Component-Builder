...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaModuleFilesFoldersUrls\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_module_files_folders_urls';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Module Files Folders Urls';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-module-files-folders-urls.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'joomla-module-files-folders-urls.json';
