...
namespace VDM\Joomla\Componentbuilder\Package\ComponentUpdates\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_updates';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Updates';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-updates.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-updates.json';
