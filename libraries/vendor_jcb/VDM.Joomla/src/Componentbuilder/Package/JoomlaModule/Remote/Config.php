...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaModule\Remote;
...
final class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_module';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Module';
	 ...
	 * @since  5.1.1
	 */
	protected string $main_readme_path = 'README_MODULES.md';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-module.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/joomla_module';
