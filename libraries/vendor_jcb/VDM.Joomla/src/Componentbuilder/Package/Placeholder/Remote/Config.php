...
namespace VDM\Joomla\Componentbuilder\Package\Placeholder\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'placeholder';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Placeholder';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/placeholder.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/placeholder';
	 ...
	 * @since  5.1.1
	 */
	protected string $guid_field = 'target';
}
