...
namespace VDM\Joomla\Componentbuilder\Package\LibraryConfig\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'library_config';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Library Config';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/library-config.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'library-config.json';
