...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaPluginUpdates\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_plugin_updates';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Plugin Updates';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-plugin-updates.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'joomla-plugin-updates.json';
