...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaPlugin\Remote;
...
final class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_plugin';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Plugin';
	 ...
	 * @since  5.1.1
	 */
	protected string $main_readme_path = 'README_PLUGINS.md';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-plugin.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/joomla_plugin';
