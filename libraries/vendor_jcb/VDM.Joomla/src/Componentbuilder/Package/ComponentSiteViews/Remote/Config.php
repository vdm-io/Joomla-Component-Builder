...
namespace VDM\Joomla\Componentbuilder\Package\ComponentSiteViews\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_site_views';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Site Views';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-site-views.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-site-views.json';
