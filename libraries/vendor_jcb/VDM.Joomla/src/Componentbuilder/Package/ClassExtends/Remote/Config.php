...
namespace VDM\Joomla\Componentbuilder\Package\ClassExtends\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'class_extends';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Class Extends';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/class-extends.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/class_extends';
}
