...
namespace VDM\Joomla\Componentbuilder\Package\JoomlaPluginGroup\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'joomla_plugin_group';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Joomla Plugin Group';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/joomla-plugin-group.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/joomla_plugin_group';
}
