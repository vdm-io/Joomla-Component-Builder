...
namespace VDM\Joomla\Componentbuilder\Package\Template\Remote;
...
final class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Template';
	 ...
	 * @since  5.1.1
	 */
	protected string $main_readme_path = 'README_TEMPLATES.md';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/template.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/template';
