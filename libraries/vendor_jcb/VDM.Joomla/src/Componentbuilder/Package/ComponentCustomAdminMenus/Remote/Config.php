...
namespace VDM\Joomla\Componentbuilder\Package\ComponentCustomAdminMenus\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_custom_admin_menus';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Custom Admin Menus';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-custom-admin-menus.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-custom-admin-menus.json';
