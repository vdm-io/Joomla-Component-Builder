...
namespace VDM\Joomla\Componentbuilder\Package\SiteView\Remote;
...
final class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'site_view';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Site View';
	 ...
	 * @since  5.1.1
	 */
	protected string $main_readme_path = 'README_SITE_VIEWS.md';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/site-view.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/site_view';
