...
namespace VDM\Joomla\Componentbuilder\Package\ComponentConfig\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_config';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Config';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-config.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-config.json';
