...
namespace VDM\Joomla\Componentbuilder\Package\ComponentModules\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_modules';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Modules';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-modules.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-modules.json';
