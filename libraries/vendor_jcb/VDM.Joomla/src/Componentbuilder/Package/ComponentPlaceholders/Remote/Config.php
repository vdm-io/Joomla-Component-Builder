...
namespace VDM\Joomla\Componentbuilder\Package\ComponentPlaceholders\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'component_placeholders';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Component Placeholders';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'index/component-placeholders.json';
	 ...
	 * @since 3.2.2
	 */
	protected string $settings_name = 'component-placeholders.json';
