...
namespace VDM\Joomla\Componentbuilder\SnippetType\Remote;
...
class Config extends ExtendingConfig implements ConfigInterface
{
	 ...
	 * @since  5.0.3
	 */
	protected string $table = 'snippet_type';
	 ...
	 * @since 3.2.2
	 */
	protected ?string $area = 'Snippet Type';
	 ...
	 * @since 3.2.2
	 */
	protected string $index_path = 'snippet-type.json';
	 ...
	 * @since  5.1.1
	 */
	protected string $src_path = 'src/snippet_type';
}
