...
final class MoveFieldsRules implements MoveFieldsRulesInterface
{
	...
	protected function moveCustomField(array $field, string $path): void
	{
		...
		$source = $this->paths->component_path . '/admin/models/fields/' . $typeName . '.php';
		$target = $path . '/fields/' . $typeName . '.php';
	...
	protected function moveValidationRule(array $field, string $path): void
	{
		...
		$source = $this->paths->component_path . '/admin/models/rules/' . $linkedRule . '.php';
		$target = $path . '/rules/' . $linkedRule . '.php';
