...
/**
 * Admin View Add Modal ToolBar Class for Joomla 3
 * 
 * @since 5.1.4
 */
final class AddModalToolBar implements AddModalToolBarInterface
{
	...
	protected function buildModalReadonlyToolbar(array $view, string $nameSingleCode): string
	{
		...
		$toolBar = "Joomla__" . "_39403062_84fb_46e0_bac4_0023f766e827___Power::getApplication()->input->set('hidemainmenu', true);";
