...
namespace VDM\Joomla\Componentbuilder\Compiler\Architecture\JoomlaThree\SiteView;
...
/**
 * Site View Add ToolBar Class for Joomla 3
 * 
 * @since 5.1.4
 */
final class AddToolBar implements AddToolBarInterface
{
	...
	{
		// Step 1: Add custom buttons
		$toolBar = $this->addCustomButtons($view);

		// Step 2: Add help and inline help
		$toolBar .= $this->addHelpSection($nameSingleCode);

		// Step 3: Prepare toolbar
	...
	{
		$toolBar = PHP_EOL . Indent::_(2)
			. "//" . Line::_(__LINE__, __CLASS__) . " now initiate the toolbar";
		$toolBar .= PHP_EOL . Indent::_(2) . "\$this->toolbar = Toolbar::getInstance();";
