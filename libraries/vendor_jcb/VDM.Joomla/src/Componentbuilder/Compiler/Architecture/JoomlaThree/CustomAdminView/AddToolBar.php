...
namespace VDM\Joomla\Componentbuilder\Compiler\Architecture\JoomlaThree\CustomAdminView;
...
/**
 * Custom Admin View Add ToolBar Class for Joomla 3
 * 
 * @since 5.1.4
 */
final class AddToolBar implements AddToolBarInterface
{
	...
	protected function buildToolbar(array $view, string $nameSingleCode): string
	{
		...
		$toolBar  .= $this->buildTitle($langView, $icomoon);
	...
	{
		return "\$this->app->input->set('hidemainmenu', true);" . PHP_EOL;
	}
	 ...
	 * @since  5.1.4
	 */
	protected function buildTitle(string $langView, string $icomoon): string
	{
