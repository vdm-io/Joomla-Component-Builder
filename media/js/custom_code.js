...
// Some Global Values
jform_vvvvwamvwm_required = false;
jform_vvvvwanvwn_required = false;
jform_vvvvwanvwo_required = false;
jform_vvvvwanvwp_required = false;
...
function vvvvwam(target_vvvvwam)
{
	...
	else
	{
		...
		if (!jform_vvvvwamvwm_required)
		{
			...
			jform_vvvvwamvwm_required = true;
		}
...
function vvvvwan(target_vvvvwan)
{
	...
	else
	{
		...
		if (!jform_vvvvwanvwn_required)
		{
			...
			jform_vvvvwanvwn_required = true;
		}
		...
		if (!jform_vvvvwanvwo_required)
		{
			...
			jform_vvvvwanvwo_required = true;
		}
		...
		if (!jform_vvvvwanvwp_required)
		{
			...
			jform_vvvvwanvwp_required = true;
		}
	}
}
