...
/** @var \VDM\Component\Componentbuilder\Administrator\View\Layouts\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=layouts&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
