...
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=component_placeholders&layout=' . $layout . $tmpl . '&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-md-12">
				<fieldset id="fieldset-rules" class="options-form">
					<legend><?php echo Text::_('COM_COMPONENTBUILDER_COMPONENT_PLACEHOLDERS_PERMISSION'); ?></legend>
					<div>
