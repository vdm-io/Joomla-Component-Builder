...
/** @var \VDM\Component\Componentbuilder\Administrator\View\Snippets\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=snippets&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
