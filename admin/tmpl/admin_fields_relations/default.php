...
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=admin_fields_relations&layout=' . $layout . $tmpl . '&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
