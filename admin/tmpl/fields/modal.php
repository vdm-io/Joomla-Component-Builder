...
/** @var \VDM\Component\Componentbuilder\Administrator\View\Fields\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=fields&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
