...
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=joomla_plugin_updates&layout=' . $layout . $tmpl . '&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">

<?php echo LayoutHelper::render('joomla_plugin_updates.updates_above', $this); ?>
<div class="main-card">

	<?php echo Html::_('uitab.startTabSet', 'joomla_plugin_updatesTab', ['active' => 'updates', 'recall' => true]); ?>

	<?php echo Html::_('uitab.addTab', 'joomla_plugin_updatesTab', 'updates', Text::_('COM_COMPONENTBUILDER_JOOMLA_PLUGIN_UPDATES_UPDATES', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'joomla_plugin_updatesTab', 'publishing', Text::_('COM_COMPONENTBUILDER_JOOMLA_PLUGIN_UPDATES_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'joomla_plugin_updatesTab', 'permissions', Text::_('COM_COMPONENTBUILDER_JOOMLA_PLUGIN_UPDATES_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
				<fieldset id="fieldset-rules" class="options-form">
					<legend><?php echo Text::_('COM_COMPONENTBUILDER_JOOMLA_PLUGIN_UPDATES_PERMISSION'); ?></legend>
					<div>
