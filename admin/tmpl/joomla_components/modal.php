...
/** @var \VDM\Component\Componentbuilder\Administrator\View\Joomla_components\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_componentbuilder&view=joomla_components&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
