 ...
 */
class ComponentbuilderControllerLibrary extends FormController
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_componentbuilder&view=libraries' . $this->getRedirectToListAppend(), false));
	...
	protected function postSaveHook(BaseDatabaseModel $model, $validData = [])
	{
		...
		if ($state->task === 'save2copy' && $state->{'library.new'})
		{
			...
			{
				// get the linked ID
				if ($_value = GetHelper::var($_updateTable, $oldID, 'library', 'id'))
				{
