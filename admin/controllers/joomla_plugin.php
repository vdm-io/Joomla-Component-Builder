 ...
 */
class ComponentbuilderControllerJoomla_plugin extends FormController
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_componentbuilder&view=joomla_plugins' . $this->getRedirectToListAppend(), false));
