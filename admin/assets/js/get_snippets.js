...
var returnError = '<div class="uk-alert uk-alert-warning"><h1>'+Joomla.JText._('COM_COMPONENTBUILDER_AN_ERROR_HAS_OCCURRED')+'!</h1><p>'+Joomla.JText._('COM_COMPONENTBUILDER_PLEASE_TRY_AGAIN_LATER')+'</p></div>';
