...
class ComponentbuilderViewLibraries_config extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_LIBRARIES_CONFIG'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/libraries_config.css", ['version' => 'auto']);
	}
