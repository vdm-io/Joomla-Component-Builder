...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'component_updatesTab', ['active' => 'updates', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'component_updatesTab', 'updates', Text::_('COM_COMPONENTBUILDER_COMPONENT_UPDATES_UPDATES', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'component_updatesTab', 'clone', Text::_('COM_COMPONENTBUILDER_COMPONENT_UPDATES_CLONE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_updatesTab', 'publishing', Text::_('COM_COMPONENTBUILDER_COMPONENT_UPDATES_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_updatesTab', 'permissions', Text::_('COM_COMPONENTBUILDER_COMPONENT_UPDATES_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
