...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'component_placeholdersTab', ['active' => 'details', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'component_placeholdersTab', 'details', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLACEHOLDERS_DETAILS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'component_placeholdersTab', 'clone', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLACEHOLDERS_CLONE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_placeholdersTab', 'publishing', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLACEHOLDERS_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_placeholdersTab', 'permissions', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLACEHOLDERS_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
