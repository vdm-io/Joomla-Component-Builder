...
Html::_('formbehavior.chosen', '.multipleJoomlacomponentsfiltercompanyname', null, ['placeholder_text_multiple' => '- ' . Text::_('COM_COMPONENTBUILDER_FILTER_SELECT_COMPANY_NAME') . ' -']);
Html::_('formbehavior.chosen', '.multipleJoomlacomponentsfilterauthor', null, ['placeholder_text_multiple' => '- ' . Text::_('COM_COMPONENTBUILDER_FILTER_SELECT_AUTHOR') . ' -']);
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_COMPONENTBUILDER_JOOMLA_COMPONENTS_BATCH_OPTIONS'),
