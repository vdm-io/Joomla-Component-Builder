...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'library_files_folders_urlsTab', ['active' => 'basic', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'library_files_folders_urlsTab', 'basic', Text::_('COM_COMPONENTBUILDER_LIBRARY_FILES_FOLDERS_URLS_BASIC', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'library_files_folders_urlsTab', 'advance', Text::_('COM_COMPONENTBUILDER_LIBRARY_FILES_FOLDERS_URLS_ADVANCE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'library_files_folders_urlsTab', 'publishing', Text::_('COM_COMPONENTBUILDER_LIBRARY_FILES_FOLDERS_URLS_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'library_files_folders_urlsTab', 'permissions', Text::_('COM_COMPONENTBUILDER_LIBRARY_FILES_FOLDERS_URLS_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
