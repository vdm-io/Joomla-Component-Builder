...
class ComponentbuilderViewComponents_custom_admin_views extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_CUSTOM_ADMIN_VIEWS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_custom_admin_views.css", ['version' => 'auto']);
	}
