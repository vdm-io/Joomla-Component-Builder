...
class ComponentbuilderViewJoomla_plugins_files_folders_urls extends HtmlView
{
	...
	protected function addToolBar()
	{
		...
		if ($this->canCreate)
		{
			ToolbarHelper::addNew('joomla_plugin_files_folders_urls.add');
		}
		...
		if (ArrayHelper::check($this->items))
		{
			if ($this->canEdit)
			{
				ToolbarHelper::editList('joomla_plugin_files_folders_urls.edit');
			}

			if ($this->canState)
			{
				ToolbarHelper::publishList('joomla_plugins_files_folders_urls.publish');
				ToolbarHelper::unpublishList('joomla_plugins_files_folders_urls.unpublish');
				ToolbarHelper::archiveList('joomla_plugins_files_folders_urls.archive');

				if ($this->canDo->get('core.admin'))
				{
					ToolbarHelper::checkin('joomla_plugins_files_folders_urls.checkin');
				}
			}
			...
			{
				ToolbarHelper::deleteList('', 'joomla_plugins_files_folders_urls.delete', 'JTOOLBAR_EMPTY_TRASH');
			}
			elseif ($this->canState && $this->canDelete)
			{
				ToolbarHelper::trash('joomla_plugins_files_folders_urls.trash');
			}
		}
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_JOOMLA_PLUGINS_FILES_FOLDERS_URLS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/joomla_plugins_files_folders_urls.css", ['version' => 'auto']);
	}
