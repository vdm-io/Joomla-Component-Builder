...
class ComponentbuilderViewSnippet_types extends HtmlView
{
	...
	protected function addToolBar()
	{
		...
		if ($this->canCreate)
		{
			ToolbarHelper::addNew('snippet_type.add');
		}
		...
		if (ArrayHelper::check($this->items))
		{
			if ($this->canEdit)
			{
				ToolbarHelper::editList('snippet_type.edit');
			}

			if ($this->canState)
			{
				ToolbarHelper::publishList('snippet_types.publish');
				ToolbarHelper::unpublishList('snippet_types.unpublish');
				ToolbarHelper::archiveList('snippet_types.archive');

				if ($this->canDo->get('core.admin'))
				{
					ToolbarHelper::checkin('snippet_types.checkin');
				}
			}
			...
			{
				ToolbarHelper::deleteList('', 'snippet_types.delete', 'JTOOLBAR_EMPTY_TRASH');
			}
			elseif ($this->canState && $this->canDelete)
			{
				ToolbarHelper::trash('snippet_types.trash');
			}
		}
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_SNIPPET_TYPES'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/snippet_types.css", ['version' => 'auto']);
	}
