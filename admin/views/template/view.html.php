...
class ComponentbuilderViewTemplate extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_COMPONENTBUILDER_TEMPLATE_NEW' : 'COM_COMPONENTBUILDER_TEMPLATE_EDIT'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/template.css", ['version' => 'auto']);
		// Add Ajax Token
		$this->getDocument()->addScriptDeclaration("var token = '" . Session::getFormToken() . "';");
		Html::_('script', $this->script, ['version' => 'auto']);
		Html::_('script', "administrator/components/com_componentbuilder/views/template/submitbutton.js", ['version' => 'auto']);
