...
class ComponentbuilderViewComponents_site_views extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_SITE_VIEWS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_site_views.css", ['version' => 'auto']);
	}
