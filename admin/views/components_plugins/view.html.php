...
class ComponentbuilderViewComponents_plugins extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_PLUGINS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_plugins.css", ['version' => 'auto']);
	}
