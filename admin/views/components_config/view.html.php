...
class ComponentbuilderViewComponents_config extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_CONFIG'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_config.css", ['version' => 'auto']);
	}
