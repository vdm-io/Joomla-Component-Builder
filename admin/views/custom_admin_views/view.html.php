...
class ComponentbuilderViewCustom_admin_views extends JViewLegacy
{
	...
	protected function addToolBar()
	{
		...
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			...
			$this->add_php_ajaxOptions = JFormHelper::loadFieldType('customadminviewsfilteraddphpajax')->options;
		...
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			...
			$this->add_custom_buttonOptions = JFormHelper::loadFieldType('customadminviewsfilteraddcustombutton')->options;
