...
class ComponentbuilderViewComponents_custom_admin_menus extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_CUSTOM_ADMIN_MENUS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_custom_admin_menus.css", ['version' => 'auto']);
	}
