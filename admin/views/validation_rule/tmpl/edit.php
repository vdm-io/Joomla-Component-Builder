...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'validation_ruleTab', ['active' => 'extends_formrule', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'validation_ruleTab', 'extends_formrule', Text::_('COM_COMPONENTBUILDER_VALIDATION_RULE_EXTENDS_FORMRULE', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'validation_ruleTab', 'publishing', Text::_('COM_COMPONENTBUILDER_VALIDATION_RULE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'validation_ruleTab', 'permissions', Text::_('COM_COMPONENTBUILDER_VALIDATION_RULE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
