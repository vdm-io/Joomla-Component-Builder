...
class ComponentbuilderViewValidation_rule extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_COMPONENTBUILDER_VALIDATION_RULE_NEW' : 'COM_COMPONENTBUILDER_VALIDATION_RULE_EDIT'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/validation_rule.css", ['version' => 'auto']);
		// Add Ajax Token
		$this->getDocument()->addScriptDeclaration("var token = '" . Session::getFormToken() . "';");
		Html::_('script', $this->script, ['version' => 'auto']);
		Html::_('script', "administrator/components/com_componentbuilder/views/validation_rule/submitbutton.js", ['version' => 'auto']);
