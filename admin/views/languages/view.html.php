...
class ComponentbuilderViewLanguages extends HtmlView
{
	...
	protected function addToolBar()
	{
		...
		if (ArrayHelper::check($this->items))
		{
			...
			{
				ToolbarHelper::custom('languages.exportData', 'download', '', 'COM_COMPONENTBUILDER_EXPORT_DATA', true);
			}
		}
		...
		{
			ToolbarHelper::custom('languages.importData', 'upload', '', 'COM_COMPONENTBUILDER_IMPORT_DATA', false);
		}
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_LANGUAGES'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/languages.css", ['version' => 'auto']);
	}
