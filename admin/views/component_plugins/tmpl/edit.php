...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'component_pluginsTab', ['active' => 'plugins', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'component_pluginsTab', 'plugins', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLUGINS_PLUGINS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'component_pluginsTab', 'clone', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLUGINS_CLONE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_pluginsTab', 'publishing', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLUGINS_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_pluginsTab', 'permissions', Text::_('COM_COMPONENTBUILDER_COMPONENT_PLUGINS_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
