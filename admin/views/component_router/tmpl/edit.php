...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'component_routerTab', ['active' => 'settings', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'component_routerTab', 'settings', Text::_('COM_COMPONENTBUILDER_COMPONENT_ROUTER_SETTINGS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'component_routerTab', 'publishing', Text::_('COM_COMPONENTBUILDER_COMPONENT_ROUTER_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_routerTab', 'permissions', Text::_('COM_COMPONENTBUILDER_COMPONENT_ROUTER_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
