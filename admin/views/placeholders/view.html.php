...
class ComponentbuilderViewPlaceholders extends HtmlView
{
	...
	protected function addToolBar()
	{
		...
		if (ArrayHelper::check($this->items))
		{
			...
			{
				ToolbarHelper::custom('placeholders.exportData', 'download', '', 'COM_COMPONENTBUILDER_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('placeholder.import'))
		{
			ToolbarHelper::custom('placeholders.importData', 'upload', '', 'COM_COMPONENTBUILDER_IMPORT_DATA', false);
		}
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_PLACEHOLDERS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/placeholders.css", ['version' => 'auto']);
	}
