...
class ComponentbuilderViewComponents_updates extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_UPDATES'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_updates.css", ['version' => 'auto']);
	}
