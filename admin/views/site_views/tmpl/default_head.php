...
<tr>
	...
	<?php if ($this->canState): ?>
		<th width="10" class="nowrap center" >
			<?php echo Html::_('searchtools.sort', 'COM_COMPONENTBUILDER_SITE_VIEW_STATUS', 'a.published', $this->listDirn, $this->listOrder); ?>
		</th>
	<?php else: ?>
		<th width="10" class="nowrap center" >
			<?php echo Text::_('COM_COMPONENTBUILDER_SITE_VIEW_STATUS'); ?>
		</th>
	<?php endif; ?>
	<th width="5" class="nowrap center hidden-phone" >
			<?php echo Html::_('searchtools.sort', 'COM_COMPONENTBUILDER_SITE_VIEW_ID', 'a.id', $this->listDirn, $this->listOrder); ?>
	</th>
</tr>