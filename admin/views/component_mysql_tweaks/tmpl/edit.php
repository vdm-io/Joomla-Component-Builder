...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'component_mysql_tweaksTab', ['active' => 'mysql_tweaks', 'recall' => true]); ?>

	<?php echo Html::_('bootstrap.addTab', 'component_mysql_tweaksTab', 'mysql_tweaks', Text::_('COM_COMPONENTBUILDER_COMPONENT_MYSQL_TWEAKS_MYSQL_TWEAKS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'component_mysql_tweaksTab', 'clone', Text::_('COM_COMPONENTBUILDER_COMPONENT_MYSQL_TWEAKS_CLONE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_mysql_tweaksTab', 'publishing', Text::_('COM_COMPONENTBUILDER_COMPONENT_MYSQL_TWEAKS_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'component_mysql_tweaksTab', 'permissions', Text::_('COM_COMPONENTBUILDER_COMPONENT_MYSQL_TWEAKS_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
