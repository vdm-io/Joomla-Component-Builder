...
class ComponentbuilderViewComponents_modules extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_MODULES'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_modules.css", ['version' => 'auto']);
	}
