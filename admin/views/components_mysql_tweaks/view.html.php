...
class ComponentbuilderViewComponents_mysql_tweaks extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_COMPONENTBUILDER_COMPONENTS_MYSQL_TWEAKS'));
		Html::_('stylesheet', "administrator/components/com_componentbuilder/assets/css/components_mysql_tweaks.css", ['version' => 'auto']);
	}
