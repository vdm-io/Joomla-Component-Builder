 ...
 * Compiler class
 */
class Interpretation extends Structure
{	
	/*
	...
	public function setField($setType,$taber,&$fieldValues,&$name,&$typeName,&$langView,&$viewName,&$listViewName,$placeholders,&$optionArray)
	{
		$fieldSet = '';
		if ($setType == 'option')
		{
	...
	public function setFieldValues(&$field,&$viewType,&$name,&$typeName,&$multiple,&$langLabel,$langView,&$spacerCounter,$listViewName,$viewName,$placeholders,$repeatable = false)
	{
		// reset array`
		$fieldValues	= array();
		$setCustom	= false;
