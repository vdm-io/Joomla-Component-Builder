...
You can install it quite easily and with no limitations. On [gitea](https://git.vdm.dev/joomla/Component-Builder/tags) is the latest release (4.0.1-beta2) with **ALL** its features and **ALL** concepts totally open-source and free! 
