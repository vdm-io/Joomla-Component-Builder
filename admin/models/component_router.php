 ...
 */
class ComponentbuilderModelComponent_router extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'component_router', $prefix = 'ComponentbuilderTable', $config = [])
	{
	...
	{
		return 'media/com_componentbuilder/js/component_router.js';
	}
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('component_router.delete', 'com_componentbuilder.component_router.' . (int) $record->id);
		}
		return false;
	}
