...
class ComponentbuilderModelJoomla_plugin_group extends AdminModel
{
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'joomla_plugin_group', $prefix = 'ComponentbuilderTable', $config = [])
	{
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		return Factory::getUser()->authorise('core.edit', 'com_componentbuilder.joomla_plugin_group.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
