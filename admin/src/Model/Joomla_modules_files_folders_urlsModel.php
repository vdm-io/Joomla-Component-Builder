 ...
 * @since  1.6
 */
class Joomla_modules_files_folders_urlsModel extends ListModel
{
	/**
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_modules_files_folders_urls.css'
 	];
