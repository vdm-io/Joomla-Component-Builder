		...
		if (GuidHelper::valid($entity))
		{
			...
			try
			{
				...
				if ($fileDefinition !== null)
				{
					...
					$display = LayoutHelper::render('translationimportercolumnsdisplayjfive', $displayData);
				}
				else
				{
					// change this to the layout of your custom importer easy mapping
					return ['data' => LayoutHelper::render('translationimportereasymappingjfive', []), 'state' => 0];
				}
			}
			catch (\Exception $error)
			{
