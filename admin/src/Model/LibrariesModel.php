 ...
 * @since  1.6
 */
class LibrariesModel extends ListModel
{
	/**
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/libraries.css'
 	];
	...
	protected function getListQuery()
	{
		...
		elseif (StringHelper::check($_how))
		{
