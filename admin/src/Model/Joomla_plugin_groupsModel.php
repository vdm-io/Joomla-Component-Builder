 ...
 * @since  1.6
 */
class Joomla_plugin_groupsModel extends ListModel
{
	/**
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_plugin_groups.css'
 	];
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		if ($formSubmited)
		{
			$class_extends = $input->post->get('class_extends');
