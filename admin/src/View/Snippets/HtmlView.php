...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('snippet.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('snippets.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
