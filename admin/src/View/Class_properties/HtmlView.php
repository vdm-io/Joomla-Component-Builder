...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('class_property.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('class_properties.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
