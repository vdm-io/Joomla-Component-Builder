...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('custom_admin_view.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('custom_admin_views.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
