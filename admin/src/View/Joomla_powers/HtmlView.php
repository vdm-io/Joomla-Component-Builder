...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('joomla_power.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('joomla_powers.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
