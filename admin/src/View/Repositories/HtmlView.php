...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('repository.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('repositories.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
