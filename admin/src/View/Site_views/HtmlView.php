...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('site_view.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('site_views.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
