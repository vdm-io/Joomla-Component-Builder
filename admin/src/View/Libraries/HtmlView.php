...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('library.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('libraries.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
