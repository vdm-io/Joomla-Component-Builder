...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('custom_code.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('custom_codes.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
