...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('field.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('fields.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
