...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('fieldtype.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('fieldtypes.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
