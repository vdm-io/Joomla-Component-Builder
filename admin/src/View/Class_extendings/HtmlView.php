...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if ($this->user->authorise('class_extends.pull', 'com_componentbuilder'))
		{
			// add Pull button.
			ToolbarHelper::custom('class_extendings.pullPowers', 'undo custom-button-pullpowers', '', 'COM_COMPONENTBUILDER_PULL', false);
		}
