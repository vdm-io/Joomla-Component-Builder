 ...
 * @since  1.6
 */
class Admins_fields_relationsController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Admin_fields_relations', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
