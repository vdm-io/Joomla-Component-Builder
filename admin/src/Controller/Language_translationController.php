...
/**
 * Language_translation Form Controller
 *
 * @since  1.6
 */
class Language_translationController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_COMPONENTBUILDER_LANGUAGE_TRANSLATION';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_componentbuilder&view=language_translations' . $this->getRedirectToListAppend(), false));
