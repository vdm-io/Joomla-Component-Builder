...
/**
 * Joomla_plugin_files_folders_urls Form Controller
 *
 * @since  1.6
 */
class Joomla_plugin_files_folders_urlsController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_COMPONENTBUILDER_JOOMLA_PLUGIN_FILES_FOLDERS_URLS';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_componentbuilder&view=joomla_plugins_files_folders_urls' . $this->getRedirectToListAppend(), false));
