...
/**
 * Componentbuilder Pull_selection Base Controller
 *
 * @since  1.6
 */
class Pull_selectionController extends BaseController
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $context = 'pull_selection';
	 ...
	 * @since  1.6
	 */
	protected $view_item = 'pull_selection';
