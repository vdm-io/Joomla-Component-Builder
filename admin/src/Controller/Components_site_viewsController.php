 ...
 * @since  1.6
 */
class Components_site_viewsController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_site_views', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
