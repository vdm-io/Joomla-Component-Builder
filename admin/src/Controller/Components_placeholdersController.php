 ...
 * @since  1.6
 */
class Components_placeholdersController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_placeholders', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
