 ...
 * @since  1.6
 */
class Components_configController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_config', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
