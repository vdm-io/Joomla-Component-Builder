 ...
 * @since  1.6
 */
class Components_mysql_tweaksController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_mysql_tweaks', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
