 ...
 * @since  1.6
 */
class Components_dashboardController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_dashboard', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
