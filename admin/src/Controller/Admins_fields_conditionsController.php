 ...
 * @since  1.6
 */
class Admins_fields_conditionsController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Admin_fields_conditions', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
