 ...
 * @since  1.6
 */
class Admin_fields_conditionsController extends FormController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_COMPONENTBUILDER_ADMIN_FIELDS_CONDITIONS';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_componentbuilder&view=admins_fields_conditions' . $this->getRedirectToListAppend(), false));
