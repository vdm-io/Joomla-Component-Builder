 ...
 * @since  1.6
 */
class Components_modulesController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_modules', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
