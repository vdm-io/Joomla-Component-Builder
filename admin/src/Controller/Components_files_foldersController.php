 ...
 * @since  1.6
 */
class Components_files_foldersController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_files_folders', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
