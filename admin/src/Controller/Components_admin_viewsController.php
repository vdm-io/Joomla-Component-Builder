 ...
 * @since  1.6
 */
class Components_admin_viewsController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_admin_views', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
