 ...
 * @since  1.6
 */
class Components_custom_admin_menusController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_custom_admin_menus', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
