 ...
 * @since  1.6
 */
class Components_updatesController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Component_updates', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
