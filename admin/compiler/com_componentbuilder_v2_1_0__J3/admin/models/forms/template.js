...
// Some Global Values
jform_fAANGXqPjv_required = false;

// Initial Script
jQuery(document).ready(function()
{
	var add_php_view_fAANGXq = jQuery("#jform_add_php_view input[type='radio']:checked").val();
	fAANGXq(add_php_view_fAANGXq);
});

// the fAANGXq function
function fAANGXq(add_php_view_fAANGXq)
{
	// set the function logic
	if (add_php_view_fAANGXq == 1)
	{
		jQuery('#jform_php_view').closest('.control-group').show();
		if (jform_fAANGXqPjv_required)
		{
	...
	else
	{
		...
		if (!jform_fAANGXqPjv_required)
		{
			...
			jform_fAANGXqPjv_required = true;
		}
	}
}
