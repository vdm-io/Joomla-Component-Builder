...
// Some Global Values
jform_JSrMkAMXQh_required = false;

// Initial Script
jQuery(document).ready(function()
{
	var add_php_view_JSrMkAM = jQuery("#jform_add_php_view input[type='radio']:checked").val();
	JSrMkAM(add_php_view_JSrMkAM);
});

// the JSrMkAM function
function JSrMkAM(add_php_view_JSrMkAM)
{
	// set the function logic
	if (add_php_view_JSrMkAM == 1)
	{
		jQuery('#jform_php_view').closest('.control-group').show();
		if (jform_JSrMkAMXQh_required)
		{
	...
	else
	{
		...
		if (!jform_JSrMkAMXQh_required)
		{
			...
			jform_JSrMkAMXQh_required = true;
		}
	}
}
