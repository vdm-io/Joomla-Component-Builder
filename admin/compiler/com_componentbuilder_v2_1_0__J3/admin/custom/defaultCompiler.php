...
<?php endif; ?>
	<div id="form">
        ...
        <form action="index.php?option=com_###component###&view=compiler" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
            <div>
    ...
    <div id="compiler" style="display:none;">
        ...
        <img src="components/com_###component###/assets/images/ajax-loader.gif" />
        <div class="clearfix"></div>
    </div>
</div>
<script>
